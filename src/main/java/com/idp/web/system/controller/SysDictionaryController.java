...
public class SysDictionaryController extends BaseController {
	...
	@ResponseBody
	public List<SysDictionary> list(HttpServletRequest request){
		List<SysDictionary>  sysDicts = sysDictionaryService.findBySearch(null);
		return sysDicts;
	}
	...
	@ResponseBody
	public String save(@RequestBody SysDictionary sysDictionary){
	...
	@ResponseBody
	public String delete(@RequestBody SysDictionary sysDictionary){
