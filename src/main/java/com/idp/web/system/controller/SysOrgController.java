...
public class SysOrgController extends BaseController {
	...
	@ResponseBody
	public List<SysOrg> list(HttpServletRequest request){

		List<SysOrg>  sysOrgs = sysOrgService.find(null);
		return sysOrgs;
	}
	 ...
	 */
	@RequestMapping("/org")
	public String org(String id,HttpServletRequest request){
	...
	@ResponseBody
	public String getOrgForTree(String currentId){
		JSONArray json = new JSONArray();
	...
	@ResponseBody
	public String save(@RequestBody SysOrg org){
	...
	@ResponseBody
	public String delete(@RequestBody SysOrg org, HttpServletRequest request){
		JSONObject json = new JSONObject();
		
		try {
			
			sysOrgService.delete(org.getId());
