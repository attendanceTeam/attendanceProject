...
public class SysDictionaryServiceImpl implements SysDictionaryService {
	...
	public List<SysDictionary> findBySearch(SysDictionary sysDictionary) {
		List<SysDictionary> dicts = sysDictionaryDao.find(sysDictionary);
//		List<SysDictionary> newDicts = new ArrayList<>
		for(SysDictionary dict : dicts){
			dict.setChildren(sysDictionaryDao.getByGroupId(dict.getId()));
		}
		return dicts;
	}
